...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Yes. A free account takes a moment and gives you 10 tool runs a day, plus a library to keep what you make. Pro raises that to 50 a day and Business to 100.",
  },
];
