/**
 * My Projects — hidden from the site for now.
 *
 * The page is not deleted: the entire original implementation is preserved,
 * commented out, below this stub. Nothing server-side was touched, so the
 * API routes, Firestore collections and stored files it reads are all intact.
 *
 * To bring it back: delete this stub, uncomment the block below (strip the
 * leading "// " from each line), and re-enable the nav entry in
 * components/dashboard/nav-data.ts.
 *
 * Until then the route redirects to the dashboard rather than 404-ing, so any
 * old link or bookmark still lands somewhere useful.
 */
...
/* ============================================================= */
/* ORIGINAL PAGE — DISABLED, KEPT FOR LATER                      */
/* ============================================================= */
